...
void update_sensors_and_ekf(QuaternionEKF& filter, float gyro_bias_x, float gyro_bias_y, float gyro_bias_z, float& dt_ekf, bool& run_accel_update, float& gx_out, float& gy_out, float& gz_out);
