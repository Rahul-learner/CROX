...
void Telemetry::send_telemetry(float roll, float pitch, float yaw, float dt, float desired_roll, float desired_pitch, float desired_yaw, float roll_pid, float pitch_pid, float yaw_pid) {
